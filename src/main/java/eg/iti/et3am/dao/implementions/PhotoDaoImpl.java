...
//    meals.setMealImage(imageUrl);
//    try {
//        restaurantDao.updateMeal(id, meals);
//    } catch (Exception ex) {
//        Logger.getLogger(PhotoDaoImpl.class.getName()).log(Level.SEVERE, null, ex);
//    }
//}
//        return false;
//
//    }
    ...
    private static File multipartToFile(MultipartFile multipartFile) throws IllegalStateException, IOException {
